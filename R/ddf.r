          ...
          meta.data = list(), control = list(), call = NULL)
{
  ...
  result <- switch(method,
                   ds = ddf.ds(dsmodel = dsmodel, data = data,
                   ...
                   trial = ddf.trial(dsmodel = dsmodel, mrmodel = mrmodel,
                                     data = data, meta.data = meta.data, control = control,
                                     call = match.call()),
                   trial.fi = ddf.trial.fi(mrmodel = mrmodel, data = data, meta.data = meta.data, control = control,
                                     call = match.call(), method = "trial.fi"),
                   rem = ddf.rem(dsmodel = dsmodel, mrmodel = mrmodel, data = data, meta.data = meta.data, control = control,
                                     call = match.call()),
                   rem.fi = ddf.rem.fi(mrmodel = mrmodel, data = data, meta.data = meta.data, control = control,
