...
#' @author Jeff Laake
#' @export
sim.loglinear=function(N,W,par,cov=NULL,pformula=~-1+observer+observer:distance,dformula=~-1+distance)
{
  ...
  prob=p.loglinear(par,dd,pformula=pformula,dformula=dformula)$prob
